...
const navigationLinks = [
  ...
  { to: "/user", label: "Profile", icon: RiAccountCircleLine, activeIcon: RiAccountCircleFill },
];
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <nav className="hidden lg:flex items-center">
              ...
              <div className="dropdown dropdown-end">
                <div tabIndex={0} role="button" className="flex flex-col items-center justify-center px-3 py-1 cursor-pointer group">
                  <img
                ...
                <ul tabIndex={0} className="dropdown-content menu bg-white rounded-lg shadow-lg border border-gray-200 w-56 mt-2 p-2 z-50">
                  <li className="px-3 py-2 border-b border-gray-100">
                    <Link to="/user" className="flex items-center gap-3 p-0 hover:bg-transparent">
                      <img
                        src={userProfilePicture}
                        alt="User Avatar"
                      ...
                      />
                      <div>
                        <p className="font-semibold text-gray-900">{user?.first_name ? `${user.first_name} ${user.last_name}` : "User"}</p>
                        <p className="text-xs text-gray-500">View Profile</p>
                      </div>
                    </Link>
                  </li>
                  <li className="mt-2">
                    <Link to="/logout" className="text-gray-700 hover:bg-gray-100 rounded-md">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 z-50">
        <div className="flex items-center justify-around h-14">
          ...
          <div className="relative flex-1">
            ...
            >
              <RiMore2Fill className={`w-6 h-6 ${moreMenuOpen ? "text-blue-600" : "text-gray-500"}`} />
              <span className={`text-[10px] mt-0.5 ${moreMenuOpen ? "text-blue-600 font-medium" : "text-gray-500"}`}>
                More
              </span>
            </button>
